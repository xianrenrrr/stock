# MSFT -- 综合提取 / All mentions across our research

_Aggregated from 24 mentions across 8 reports. Auto-generated; rerun via `python scripts/compress_dives_to_companies.py`._
...
| **Marvell**       | 5–8%                      | Trainium 3 (AWS), Maia (MSFT)                |
| **Others**        | 3–5%                      | Tenstorrent, Cerebras, Intel Gaudi, China-domestic tail |
...
Broadcom/Marvell-designed ASICs   ~ 18–22% (Google TPU v7, AWS Trainium 3, Meta MTIA, MSFT Maia)
        │   ($40–45 K per Blackwell-Ultra system, $70–80 K Rubin GB400)
...
> Round 2 closed. Say **"go round 3"** / **"继续 Round 3"** to move into company-by-company moat + valuation + 3+ supply-chain neighbours (Roche/Flatiron/FMI, Salesforce/MSFT cloud, Wuxi/Tigermed China, Medable/Castor DCT).
